...
<body>
    ...
    <div class="w3-container w3-center w3-animate-bottom">
        ...
        <?php
        echo "<font color= blue size=4pt face=Arial>Get this number as Special Identification Number(SID):-</font>";
        $lob = uniqid();
    ...
    <marquee behavior="scroll" scrollamount="15" direction="left">
        <h3>
            <b>Note:-</b> Please copy the Name,SID number, and City of patient before registering. All these feilds are required to generate the QR code.
        </h3>
    </marquee>
